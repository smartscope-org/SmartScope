...
urlpatterns = [
    ...
    path('tags/addprojecttag/<grid_id>/', tags.add_project_tag, name='addProjectTag'),
    path('tags/createprojecttag/<grid_id>/', tags.create_project_tag, name='createProjectTag'),
    path('tags/deleteprojecttag/<grid_id>/', tags.delete_project_tag, name='deleteProjectTag'),
